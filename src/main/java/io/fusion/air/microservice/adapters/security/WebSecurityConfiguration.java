...
public class WebSecurityConfiguration {
    ...
    /**
     * Security Filter Chain - replaces WebSecurityConfigurerAdapter.configure(HttpSecurity)
    ...
    /**
     * WebSecurityCustomizer - replaces WebSecurityConfigurerAdapter.configure(WebSecurity)
     * Tells Spring Security to ignore the specified patterns (static resources).
     */
    @Bean
