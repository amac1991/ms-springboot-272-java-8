...
/**
 * Spring Security 6 Configuration using SecurityFilterChain bean approach.
 * Migrated from the deprecated WebSecurityConfigurerAdapter pattern.
 *
...
public class WebSecurityConfiguration {
    ...
    /**
     * Configures the SecurityFilterChain bean (replaces the old configure(HttpSecurity) method).
     * Uses the new Spring Security 6 lambda DSL.
     */
    @Bean
    ...
    /**
     * Configures WebSecurityCustomizer to ignore static resource patterns.
     * Replaces the old configure(WebSecurity) method.
     */
    @Bean
